...
import 'package:invitation_maker/app/modules/graduation_party/views/g_template_1.dart';
import 'package:invitation_maker/app/modules/graduation_party/views/g_template_2.dart';
import 'package:invitation_maker/app/modules/graduation_party/views/g_template_3.dart';
...
class GraduationPartyeHome extends GetView<GraduationPartyCTL> {
  const GraduationPartyeHome({Key? key}) : super(key: key);
  @override
                      ...
                      Container(
                          ...
                          child: WidgetShot(
                            ...
                            child: Obx(() => IndexedStack(
                                  ...
                                  children: [
                                    Graduate_Template1(controller: controller),
                                    Graduate_Template2(controller: controller),
                                    Graduate_Template3(controller: controller),
                                    Graduate_Template4(controller: controller),
                                    Graduate_Template5(controller: controller),
                                    Graduate_Template6(controller: controller),
                                  ],
                                )),
                          )),
                      designSelector(),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                controller: controller.graduateNameTextController,
                cursorColor: Theme.of(context).colorScheme.primary,
                decoration: InputDecoration(
                  labelText: 'Name',
                  labelStyle: TextStyle(color: Colors.grey),
                  hintText: 'Enter the Graduate name',
                ...
                validator: (value) =>
                    value!.isEmpty ? 'Please enter the Graduate name' : null,
              ),
            ),
            SizedBox(height: 20),
            ...
            //   ),
            //   child: TextFormField(
            //     controller: controller.RSVPNameTextController,
            //     decoration: InputDecoration(
            //       labelText: 'RSVP',
            //       labelStyle: TextStyle(color: Colors.grey),
            //       hintText: 'Enter the RSVP name',
            //       hintStyle: TextStyle(color: Colors.grey.shade400),
            //       fillColor: Theme.of(context).colorScheme.secondary,
            //       filled: true,
            //       enabledBorder: OutlineInputBorder(
            ...
            //     ),
            //     validator: (value) =>
            //         value!.isEmpty ? 'Please enter the RSVP name' : null,
            //   ),
            // ),
