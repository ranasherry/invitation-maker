...
import 'package:invitation_maker/app/modules/party_card/views/p_template_1.dart';
import 'package:invitation_maker/app/modules/party_card/views/p_template_2.dart';
import 'package:invitation_maker/app/modules/party_card/views/p_template_3.dart';
...
class PartyCardHome extends GetView<partyCardCTL> {
  const PartyCardHome({Key? key}) : super(key: key);
  @override
                      ...
                      Container(
                          ...
                          child: WidgetShot(
                            ...
                            child: Obx(() => IndexedStack(
                                  ...
                                  children: [
                                    Party_Template1(controller: controller),
                                    Party_Template2(controller: controller),
                                    Party_Template3(controller: controller),
                                    Party_Template4(controller: controller),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                controller: controller.partyTypeTextController,
                decoration: InputDecoration(
