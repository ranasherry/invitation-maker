...
class babyShower_Template2 extends StatefulWidget {
  babyShower_Template2({super.key, required this.controller});
  BabyShowerCTL controller;
  @override
  State<babyShower_Template2> createState() => _babyShower_Template2State();
}

class _babyShower_Template2State extends State<babyShower_Template2> {
  String Name = "";
  String MonthName = "";
  String date = "";
  String day = "Sunday";
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Column(
            children: [
              verticalSpace(SizeConfig.blockSizeVertical * 29),
              Text(
                Name,
