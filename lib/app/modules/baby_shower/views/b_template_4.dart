...
class babyShower_Template4 extends StatefulWidget {
  babyShower_Template4({super.key, required this.controller});
  BabyShowerCTL controller;
  @override
  State<babyShower_Template4> createState() => _babyShower_Template4State();
}

class _babyShower_Template4State extends State<babyShower_Template4> {
  String Name = "";
  String MonthName = "";
  String date = "";
  String day = "Sunday";
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Column(
            children: [
              verticalSpace(SizeConfig.blockSizeVertical * 38),
              Text(
                Name,
