...
import 'package:invitation_maker/app/modules/engagement_card/views/e_template_3.dart';
...
class engagementCardHomeView extends GetView<engagementCardCTL> {
  const engagementCardHomeView({Key? key}) : super(key: key);
  @override
                      ...
                      Container(
                          ...
                          child: WidgetShot(
                            ...
                            child: Obx(() => IndexedStack(
                                  ...
                                  children: [
                                    Engagement_Template1(
                                        controller: controller),
                                    Engagement_Template2(
                                        controller: controller),
                                    Engagement_Template3(
                                        controller: controller),
                                    Engagement_Template4(
                                        controller: controller),
                                    Engagement_Template5(
                                        controller: controller),
                                    Engagement_Template6(
                                        controller: controller),
                                  ],
                                )),
                          )),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                controller: controller.maleFianceNameTextController,
                cursorColor: Theme.of(context).colorScheme.primary,
                decoration: InputDecoration(
                  labelText: 'Fiance Name',
                  labelStyle: TextStyle(color: Colors.grey),
                  hintText: 'Enter the Fiance name (male)',
                ...
                validator: (value) =>
                    value!.isEmpty ? 'Please enter the Fiance name' : null,
              ),
            ),
            SizedBox(height: 20),
            ...
            Container(
              ...
              child: TextFormField(
                controller: controller.femaleFianceNameTextController,
                decoration: InputDecoration(
                  labelText: 'Fiance Name',
                  labelStyle: TextStyle(color: Colors.grey),
                  hintText: 'Enter the Fiance name (female)',
                  hintStyle: TextStyle(color: Colors.grey.shade400),
                  fillColor: Theme.of(context).colorScheme.secondary,
                  filled: true,
                  enabledBorder: OutlineInputBorder(
